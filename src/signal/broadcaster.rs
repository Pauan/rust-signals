...
impl<A> BroadcasterInnerState<A>
where
    A: Signal,
{
...
impl<A> BroadcasterSharedState<A>
where
    A: Signal,
{
    ...
    fn poll<B, F>(&self, f: F) -> B
    where
        F: FnOnce(&BroadcasterInnerState<A>) -> B,
    {
    ...
    A: Signal,
{
    ...
    fn poll_change<B, F>(&mut self, cx: &mut Context, f: F) -> Poll<Option<B>>
    where
        F: FnOnce(&A::Item) -> B,
    {
...
pub struct BroadcasterSignal<A>
where
    A: Signal,
{
...
#[must_use = "Signals do nothing unless polled"]
pub struct BroadcasterSignalCloned<A>
where
    A: Signal,
{
    state: BroadcasterState<A>,
...
#[must_use = "Signals do nothing unless polled"]
pub struct BroadcasterSignalRef<A, F>
where
    A: Signal,
{
    state: BroadcasterState<A>,
